  ...
  cj.factory("collection-json", [
    "$http", function($http) {
      http._get = function(href, options, done) {
        ...
        return $http.get(href, options).success(function(data, status, headers, config) {
...
},{"../underscore.coffee":5,"../http.coffee":2,"./link.coffee":6,"./item.coffee":7,"./query.coffee":8,"./template.coffee":9}],6:[function(require,module,exports){(function() {
...
},{"../http.coffee":2,"../client.coffee":3,"./collection.coffee":4}],7:[function(require,module,exports){(function() {
...
},{"../underscore.coffee":5,"../http.coffee":2,"../client.coffee":3,"./collection.coffee":4,"./link.coffee":6,"./template.coffee":9}],8:[function(require,module,exports){(function() {
...
},{"../underscore.coffee":5,"../http.coffee":2,"../client.coffee":3,"./collection.coffee":4}],9:[function(require,module,exports){(function() {
