# Django settings for hypertest project.
import os
...
STATIC_ROOT = os.path.join(PROJECT_DIR, 'static_build')
...
SECRET_KEY = 'p@d+kbdw+=w!w!=#g-=_evk_ol_58s_c3wmqqw_4(j(i58-4b-'
...
ROOT_URLCONF = 'hypertest.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hypertest.wsgi.application'
